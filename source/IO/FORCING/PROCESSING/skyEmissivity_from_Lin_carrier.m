...
classdef skyEmissivity_from_Lin_carrier < matlab.mixin.Copyable %makes the TRANSFORM object
    ...
    methods
        ...
        function forcing = process(proc, forcing, tile)
            ...
            forcing.CARRIER.DATA.skyEmissivity = forcing.CARRIER.DATA.Lin ./ proc.CONST.sigma ./ (forcing.CARRIER.DATA.Tair + proc.CONST.Tmfw).^4;
