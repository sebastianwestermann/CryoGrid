...
%         end
      ...
      %              function [solar_azimuth,solar_zenith, HrAngleR, DecR]=solargeom(forcing, Time, Latitude,Longitude)  %added two arguments, SW
        ...
        %Kris script, used now to be consistent with TopoScale
        function [solar_azimuth,solar_zenith, solar_zenith_offset_from_GMT] = solargeom2(proc, Time, Latitude,Longitude)  %added two arguments, SW
            %              function [solar_azimuth,solar_zenith, HrAngleR, DecR]=solargeom(forcing, Time, Latitude,Longitude)  %added two arguments, SW
            % [saz,szen]=solargeom(time,latitude,longitude)
            % Adopted from the Sandia National Labs PVL Toolbox ephemeris routine.
            % Inputs:
            ...
            solar_zenith_offset_from_GMT = (UnivHr/24*360-HrAngle);
            solar_zenith_offset_from_GMT(solar_zenith_offset_from_GMT<0) = solar_zenith_offset_from_GMT(solar_zenith_offset_from_GMT<0)+360;
            solar_zenith_offset_from_GMT(solar_zenith_offset_from_GMT>360) = solar_zenith_offset_from_GMT(solar_zenith_offset_from_GMT>360)-360;
            solar_zenith_offset_from_GMT = solar_zenith_offset_from_GMT/360;
        end
