classdef DA_iterative_particle_batch_smoother_AMIS_ML < DA_FUNCTIONS
    ...
    methods
        function da = provide_PARA(da)
            ...
            da.PARA.ancillary_features_class = []; %must be H_LIST, additional variables that can be used as featuresin the ML
            da.PARA.ancillary_features_class_index = [];
