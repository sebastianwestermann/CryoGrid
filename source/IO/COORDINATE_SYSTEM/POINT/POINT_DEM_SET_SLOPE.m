%========================================================================
% CryoGrid SPATIAL_REFERENCE class POINT_DEM_SET_SLOPE
% Corresponds to POINT_DEM except that the slope is set by the parameter
% sheet. DEsigned for case where the altitude or horizon angles are
% unknown, but you want to prescribe a know exposition (e.g. flat mountain
% top, sensor orientation, representative hillslope).
% 
% NOTE: if slope_angle or aspect are given in "variables" field, the user
% set values will be overwritten by the DEM-derived values!
%
% POINT_DEM
...
%
% R. Zweigel, S. Westermann, Nov 2023
%========================================================================


classdef POINT_DEM_SET_SLOPE < DEM_BASE
    properties
        RUN_INFO
    end
    ...
    methods
        function point = provide_PARA(point)
            ...
            point.PARA.variables = []; % altitude or altitude, horizon_angles
...
%             
        ...
        function point = param_file_info(point)
            ...
            point.PARA.comment.variables = {'properties calculated from DEM: altitude OR altitude and horizon_angles'};
            point.PARA.options.variables.name = 'H_LIST';
            point.PARA.options.variables.entries_x = {'altitude' 'horizon_angles'};
