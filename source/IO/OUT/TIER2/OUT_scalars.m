...
classdef OUT_scalars < OUT_BASE
    ...
    methods
        ...
        function out = finalize_init(out, tile)
            ...
            out.TEMP.output_var = 'CG_surfaceVars';
            out.TEMP.keyword = 'surfaceVars';
       ...
       function out = store_OUT(out, tile)
        ...
        function out = state2out(out, tile)
            ...
            for k=1:size(out.PARA.variables,1)
                if any(strcmp(fieldnames(tile.TOP.NEXT.STATVAR), out.PARA.variables{k,1}))
                    out.STATVAR.(out.PARA.variables{k,1}) = [out.STATVAR.(out.PARA.variables{k,1}); tile.TOP.NEXT.STATVAR.(out.PARA.variables{k,1})];
                else
                    out.STATVAR.(out.PARA.variables{k,1}) = [out.STATVAR.(out.PARA.variables{k,1}); NaN];
                end
            end
