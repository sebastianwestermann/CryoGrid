...
classdef ESA_CCI_global_run_MODIS_deg_restart < matlab.mixin.Copyable
    ...
    methods
        ...
        function update = assign_run_info_properties(update, run_info)
            ...
            run_info.PPROVIDER.CLASSES.MULTITILE_ESA_CCI{1,1}.PARA.restart_file_path = [ run_info.PPROVIDER.CLASSES.MULTITILE_ESA_CCI{1,1}.PARA.restart_file_path tile_str '/'];
