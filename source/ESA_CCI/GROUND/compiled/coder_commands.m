codegen advance_E_compiled2 -args {zeros(44,2100), zeros(44,2100),0}
codegen compact_windDrift_compiled2 -args {zeros(4,2100), zeros(4,2100), zeros(4,2100), zeros(4,2100), zeros(1,2100), 0}
codegen dE_dt_compiled2 -args {zeros(44,2100), zeros(44,2100), zeros(45,2100), zeros(44,2100)}
codegen get_Tground_compiled2 -args {zeros(44,2100), zeros(41,2100), zeros(41,2100), zeros(41,2100), zeros(41,2100)}
codegen thermCond_compiled2 -args {zeros(45,2100), zeros(41,2100), zeros(41,2100), zeros(41,2100), zeros(41,2100)}
codegen thermCond_eff_compiled2 -args {zeros(45,2100), zeros(45,2100)}
codegen thermCond_snow_compiled2 -args {zeros(4,2100), zeros(4,2100), zeros(4,2100)}
...
codegen get_boundary_condition_u_compiled2 -args {zeros(45,2100), zeros(1,2100), zeros(1,2100), zeros(1,2100), 0,0, zeros(1,2100), zeros(1,2100), zeros(4,2100), zeros(1,2100), zeros(44,2100), zeros(4,2100), 0, 0, zeros(4,2100), zeros(1,2100)}
