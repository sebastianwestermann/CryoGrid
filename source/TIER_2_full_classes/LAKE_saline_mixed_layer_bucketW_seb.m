...
classdef LAKE_saline_mixed_layer_bucketW_seb < SEB & HEAT_CONDUCTION & LAKE & SALT & WATER_FLUXES & REGRID & HEAT_FLUXES_LATERAL 
    ...
    methods
        ...
        function ground = compute_diagnostic(ground, tile)
            ...
            ground = stratify_saline_mixed_layer(ground, tile);
            ground = regrid_merge(ground, {'layerThick'; 'energy'; 'waterIce'; 'mineral'; 'organic'; 'salt_conc'}, {'area'; 'thermCond'}, 'waterIce');   
            ground = regrid_split_first_cell(ground, {'energy'; 'layerThick'; 'waterIce'; 'mineral'; 'organic'; 'salt_conc'}, {'area'; 'thermCond'});
