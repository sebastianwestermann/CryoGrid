...
%             snow.TEMP.sublim = 0; % Naming convention from GROUND
%             snow.TEMP.sublim_energy = 0; % Naming convention from GROUND
        ...
        function snow = surface_energy_balance(snow, forcing)
            ...
            [snow, ~] = penetrate_LW(snow, forcing.TEMP.Lin .* snow.STATVAR.area(1));
            
            [snow, ~] = penetrate_SW(snow, forcing.TEMP.Sin .* snow.STATVAR.area(1)); %distribute SW radiation
