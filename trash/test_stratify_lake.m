...
%bottom layer mixing
mixed_layer_bottom_cell = size(T,1);
moment0 = 0;
moment1 = 0;
energy_mixing = 0;
...
while mixed_layer_bottom_cell>1 && density_mixed_layer <= density_water(mixed_layer_bottom_cell-1,1)
    ...
    T_mixed_layer = mean(T(mixed_layer_bottom_cell:end,1));
...
%mix the layer
T_mixed_layer = mean(T(mixed_layer_bottom_cell:end,1));
T(mixed_layer_bottom_cell:end,1) = T_mixed_layer;
density_mixed_layer = density_H2O(T_mixed_layer);
density_water(mixed_layer_bottom_cell:end,1) = density_mixed_layer;
